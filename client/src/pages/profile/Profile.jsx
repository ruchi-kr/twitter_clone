...
export default function Profile() {
  ...
  const handleFollow = async () => {
    ...
    localStorage.setItem(
      "user",
      JSON.stringify({ ...userFromLocal, followings: updatedFollowingList })
    );
          ...
          <div className={styles.profile}>
                ...
                <div className={styles["button-div"]}>
                  ...
                  {user && account.username === user.username ? (
                    <button
                      ...
                      className={styles["profile-button-following"]}
                    >
                      Edit profile
                    </button>
                  ) : (
                    user && (
                      <button
                        ...
                        className={
                          styles[
                            "profile-button-" + followingStatus.toLowerCase()
                          ]
                        }
                      >
                        {followingStatus}
            ...
            <div className={styles.info}>
              ...
              <div className={styles.follow}>
                <p>
                  <b>{account.followings.length}</b> Following
                </p>
                <p>
                  <b>{account.followers.length}</b> Followers
                </p>
              </div>
            </div>
